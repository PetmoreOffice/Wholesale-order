export const catalogFields = `
  ...
  d.ICDEPT_KEY AS departmentId, d.ICDEPT_CODE AS departmentCode,
  COALESCE(NULLIF(LTRIM(RTRIM(d.ICDEPT_THAIDESC)), ''), NULLIF(LTRIM(RTRIM(d.ICDEPT_ENGDESC)), '')) AS departmentName,
